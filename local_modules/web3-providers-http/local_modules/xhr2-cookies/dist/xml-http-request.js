...
var XMLHttpRequest = /** @class */ (function (_super) {
    ...
    XMLHttpRequest.prototype._finalizeHeaders = function () {
        this._headers = __assign(__assign(__assign({}, this._headers), { Connection: 'keep-alive', Host: this._url.host, 'User-Agent': this._userAgent }), this._anonymous ? { Referer: 'about:blank' } : {});
